...
setup(
    ...
    install_requires=["openstacksdk", "munch", "pytz"],
    extras_require={":python_version<'3.3'": ["py2-ipaddress"]},
    entry_points={
        "console_scripts": ["cloud-clean=cloud_cleaner.bin.entrypoint:cloud_clean"]
    },
)
